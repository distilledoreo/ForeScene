...
5. Run `npm run lint:fast` and the directly relevant Vitest file while iterating; before merge run `npm run lint`, `npm run test`, and Help workspace smoke coverage when Help/UI labels changed.
