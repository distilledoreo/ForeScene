...
export const HUMAN_JOINT_LABELS: Record<HumanJointId, string> = {
  ...
  spine: 'Spine',
  chest: 'Chest',
  upperSpine: 'Upper spine',
  neck: 'Neck',
  head: 'Head',
  leftClavicle: 'Left clavicle',
  leftUpperArm: 'Left upper arm',
  leftUpperArmTwist: 'Left upper arm twist',
  leftLowerArm: 'Left lower arm',
  leftLowerArmTwist: 'Left lower arm twist',
  leftHand: 'Left hand',
  leftHandEnd: 'Left hand tip',
  rightClavicle: 'Right clavicle',
  rightUpperArm: 'Right upper arm',
  rightUpperArmTwist: 'Right upper arm twist',
  rightLowerArm: 'Right lower arm',
  rightLowerArmTwist: 'Right lower arm twist',
  rightHand: 'Right hand',
  rightHandEnd: 'Right hand tip',
  leftUpperLeg: 'Left hip',
  leftUpperLegTwist: 'Left thigh twist',
  leftLowerLeg: 'Left lower leg',
  leftLowerLegTwist: 'Left shin twist',
  leftFoot: 'Left foot',
  leftToeBase: 'Left toes',
  rightUpperLeg: 'Right hip',
  rightUpperLegTwist: 'Right thigh twist',
  rightLowerLeg: 'Right lower leg',
  rightLowerLegTwist: 'Right shin twist',
...
export const HUMAN_JOINT_MIRROR: Partial<Record<HumanJointId, HumanJointId>> = {
  ...
  rightUpperArmTwist: 'leftUpperArmTwist',
  leftLowerArm: 'rightLowerArm',
  leftLowerArmTwist: 'rightLowerArmTwist',
  rightLowerArm: 'leftLowerArm',
  rightLowerArmTwist: 'leftLowerArmTwist',
  leftHand: 'rightHand',
  ...
  rightUpperLegTwist: 'leftUpperLegTwist',
  leftLowerLeg: 'rightLowerLeg',
  leftLowerLegTwist: 'rightLowerLegTwist',
  rightLowerLeg: 'leftLowerLeg',
  rightLowerLegTwist: 'leftLowerLegTwist',
  leftFoot: 'rightFoot',
