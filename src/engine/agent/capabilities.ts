...
export const AGENT_INSPECT_COMMANDS = [
  ...
  'shot.visualPreflight.inspect',
  'shot.visualPreflight.collect',
  'shot.assetPose.inspect',
  'shot.preparedMedia.inspect',
  'app.provenance',
  'app.beginRunSession',
  'app.recordRunValidation',
  'artifact.download',
...
export const AGENT_MUTATE_COMMANDS = [
  ...
  'shot.repair.begin',
  'shot.repair.evaluate',
  'shot.repair.commitBest',
  ...
  'shot.capturePreparedMedia',
  'shot.regenerateStills',
  'shot.retryFailedStills',
  'shot.cancelStillPreparation',
  'pose.setJoint',
  'pose.applyPreset',
  'pose.mirror',
  'pose.resetJoint',
